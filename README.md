...
Указатель хранит количество элементов массива в байтах. Хранение происходит перед указателем на первый элемент (либо *(ptr - 1), либо *(ptr - 2), в разных компиляторах по-разному).
